...
public class VvDetailsActivity extends Activity implements LoaderCallback {
	...
	private void displayData() {
		...
		addDetailView(llMain, R.string.detailsTitle, VvDetails.INDEX_TITEL);
		addDetailView(llMain, R.string.detailsType, VvDetails.INDEX_TYPE);
		addDetailView(llMain, R.string.detailsDozierende, VvDetails.INDEX_LECTURER);
		addDetailView(llMain, R.string.detailsZeit, VvDetails.INDEX_TIME_PLACE);
		...
		addDetailView(llMain, R.string.detailsAngebotsmuster,
				VvDetails.INDEX_AMUSTER);
		addDetailView(llMain, R.string.detailsOrganisationseinheit,
				VvDetails.INDEX_OEINHEIT);
		addDetailView(llMain, R.string.detailsModule, VvDetails.INDEX_MODULE);
		addDetailView(llMain, R.string.detailsLernziele,
				VvDetails.INDEX_LERNZIELE);
		addDetailView(llMain, R.string.detailsInhalt, VvDetails.INDEX_INHALT);
		addDetailView(llMain, R.string.detailsLiteratur,
				VvDetails.INDEX_LITERATUR);
		addViewLink(llMain, R.string.detailsWeblink, VvDetails.INDEX_LINK,
				VvDetails.INDEX_LINKDESC);
		addDetailView(llMain, R.string.detailsLeistungsüberprüfung,
				VvDetails.INDEX_LPRUEF);
		addDetailView(llMain, R.string.detailsSkala, VvDetails.INDEX_SKALA);
		addDetailView(llMain, R.string.detailsWiederholungspruefung,
				VvDetails.INDEX_WIEDERHOLUNGPRUEF);
		addDetailView(llMain, R.string.detailsAnAbmeldung,
				VvDetails.INDEX_ANABMELDUNG);
		...
		addDetailView(llMain, R.string.detailsWiederholtesBelegen,
				VvDetails.INDEX_WBELEGEN);
		addDetailView(llMain, R.string.detailsEinsatzDigitalerMedien,
				VvDetails.INDEX_PRAESENZ);
	...
	private void addViewDate(LinearLayout llMain, int label, int field) {
		...
		llMain.addView(new DetailsEntryView(this, label, string));
	}

	private void addDetailView(LinearLayout llMain, int label, int field) {
		llMain.addView(new DetailsEntryView(this, label, detailsCursor.getString(field)));
